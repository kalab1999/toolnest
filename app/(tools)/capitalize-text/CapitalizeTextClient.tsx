    ...
    return (
        <ToolLayout
            ...
            instructions={[
                ...
                "Click 'Capitalize Text' to transform the text.",
                "The tool will capitalize the first letter of each word and lowercase the rest.",
                "Copy the result using the button below."
            ]}
        >
